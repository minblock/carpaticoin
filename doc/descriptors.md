# Support for Output Descriptors in Carpaticoin Core

Since Carpaticoin Core v0.17, there is support for Output Descriptors. This is a
...
on Carpaticoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Carpaticoin Core wallets, a convenience function `combo` is
