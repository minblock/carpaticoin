Carpaticoin Core version 0.13.3 is now available from:

  <https://download.carpaticoin.org/carpaticoin-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/carpaticoin-project/carpaticoin/blob/0.13/src/chainparams.cpp#L214).
