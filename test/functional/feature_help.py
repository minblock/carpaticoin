...
"""Verify that starting carpaticoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start carpaticoin with -h for help text")
        ...
        self.log.info("Start carpaticoin with -version for version information")
        ...
        self.log.info("Start carpaticoind with -fakearg to make sure it does not start")
