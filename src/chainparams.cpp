...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting buildtiposhis!";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585974313, 1575482, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa9cc2de1b39d00574c4d440443b881cee3b98b3a8661a5598e4f7123091dddda"));
        assert(genesis.hashMerkleRoot == uint256S("0x803a2f53287df5e46dc243d9b41b24d87f4f497e7a2b6ff7c2703a393e518c7f"));
        ...
        vSeeds.emplace_back("seed-a.carpaticoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.carpaticointools.com");
        vSeeds.emplace_back("dnsseed.carpaticoinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 209757, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xc480fe899af24606873806c3b07f1bd7c17a69601491c5d690a3b5047bde710c"));
        assert(genesis.hashMerkleRoot == uint256S("0x803a2f53287df5e46dc243d9b41b24d87f4f497e7a2b6ff7c2703a393e518c7f"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.carpaticointools.com");
        vSeeds.emplace_back("seed-b.carpaticoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5936a93e4fe6a44568a9e16e2ca7548b97744696523967b0a993fef7a4e7da94"));
        assert(genesis.hashMerkleRoot == uint256S("0x803a2f53287df5e46dc243d9b41b24d87f4f497e7a2b6ff7c2703a393e518c7f"));
