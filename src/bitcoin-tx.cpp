...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " carpaticoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  carpaticoin-tx [options] <hex-tx> [commands]  Update hex-encoded carpaticoin transaction\n" +
            "or:     carpaticoin-tx [options] -create [commands]   Create hex-encoded carpaticoin transaction\n" +
            "\n";
